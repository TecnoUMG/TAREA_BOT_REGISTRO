...
public class Main {
    ...
    private static void PruebaActualizacionUsuario() throws SQLException {
        ...
        try {
            ...
            try {
                //obtener informacion del usuario por el carnet
                usurioObtenido = servicioUsuaio.getUserByCarne("0905");
                System.out.println("Retrieved User: " + usurioObtenido.getNombre());
                System.out.println("Retrieved User: " + usurioObtenido.getCorreo());
                System.out.println("Retrieved User: " + usurioObtenido.getId());
    ...
    private static void PruebaEliminarUsuario () {
            servicioUsuaio = new UserService();
        try {
